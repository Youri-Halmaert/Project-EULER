...
def segment_croise_droite(segment_points, droite_points):
    (x1, y1), (x2, y2) = segment_points
    (x3, y3), (x4, y4) = droite_points
...
for lines in P:
    ...
    B=(lines[2], lines[3])
    C=(lines[4], lines[5])
    if segment_croise_droite((A,B),(C,O)) and segment_croise_droite((A,C),(B,O)) and segment_croise_droite((B,C),(A,O)):
        count+=1
print(count)
